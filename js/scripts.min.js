 ...
 */
function(window,factory){"object"!=typeof window.WHMCS&&(window.WHMCS=factory)}(window,{hasModule:function(name){return void 0!==WHMCS[name]&&Object.getOwnPropertyNames(WHMCS[name]).length>0},loadModule:function(name,module){if(!this.hasModule(name))if(WHMCS[name]={},"function"==typeof module)module.apply(WHMCS[name]);else for(var key in module)module.hasOwnProperty(key)&&(WHMCS[name][key]={},module[key].apply(WHMCS[name][key]))}}),jQuery(document).ready((function(){jQuery(document).on("click",".disable-on-click",(function(){if(jQuery(this).addClass("disabled"),jQuery(this).hasClass("spinner-on-click")){var icon=$(this).find("i.fas,i.far,i.fal,i.fab");jQuery(icon).removeAttr("class").addClass("fas fa-spinner fa-spin")}}))})),
/**
